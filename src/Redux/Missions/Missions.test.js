...
import missionReducer, { fetchMission, joinMission, leaveMission } from './Missions';

describe('fetchMission', () => {
  test('test fetchMission function', () => {
    const result = fetchMission();
...
describe('missionReducer', () => {
  ...
  test('test missionReducer missions loaded', () => {
    ...
    const action = {
      type: 'space-traveler/Missions/FETCH_MISSIONS',
  ...
  test('test missionReducer join mission', () => {
    const state = {
      missions: [
        ...
        { id: 'F3364BF', name: 'mission 3', description: 'description 3' },
        { id: 'CE91D46', name: 'mission 4', description: 'description 4' },
      ],
    };
    const action = {
      type: 'space-traveler/Missions/JOIN_MISSION',
      payload: 'F3364BF',
    };
